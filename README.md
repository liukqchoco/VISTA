...
1. 后端：实现大模型引导的场景感知GUI探索测试的核心代码，即为该仓库
2. 前端：Web界面的实现代码请见https://github.com/Xuzhanghan/VISTA_Web/tree/master

# 作业要求

1. 工具功能：后端GUI测试代码与前端Web代码已完成，见上方补充说明
2. 项目文档：详细描述了该大作业的功能模块及交互、运行要求，可根据文档运行工具，具体内容见下方
3. 项目视频：视频配解说、字幕，能够较好呈现运行过程、关键技术挑战。视频文件位于该仓库根目录，名为“代码工具演示视频”
4. 代码规范：已添加完整注释，使项目结构尽可能清晰
